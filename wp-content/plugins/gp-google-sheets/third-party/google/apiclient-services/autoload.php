...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('GP_Google_Sheets\\Dependencies\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['GP_Google_Sheets\\Dependencies\\Google\\Client' => 'Google_Client', 'GP_Google_Sheets\\Dependencies\\Google\\Service' => 'Google_Service', 'GP_Google_Sheets\\Dependencies\\Google\\Service\\Resource' => 'Google_Service_Resource', 'GP_Google_Sheets\\Dependencies\\Google\\Model' => 'Google_Model', 'GP_Google_Sheets\\Dependencies\\Google\\Collection' => 'Google_Collection'];
