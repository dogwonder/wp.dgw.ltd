...
class SheetProperties extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(SheetProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_SheetProperties');
