...
class DataSource extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DataSource::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSource');
