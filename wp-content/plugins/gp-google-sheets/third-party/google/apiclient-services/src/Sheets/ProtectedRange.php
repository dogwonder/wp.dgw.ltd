...
class ProtectedRange extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(ProtectedRange::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ProtectedRange');
