...
class ChartAxisViewWindowOptions extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ChartAxisViewWindowOptions');
