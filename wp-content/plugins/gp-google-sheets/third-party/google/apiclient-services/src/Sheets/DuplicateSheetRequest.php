...
class DuplicateSheetRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DuplicateSheetRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DuplicateSheetRequest');
