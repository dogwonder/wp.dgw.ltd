...
class DataValidationRule extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DataValidationRule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataValidationRule');
