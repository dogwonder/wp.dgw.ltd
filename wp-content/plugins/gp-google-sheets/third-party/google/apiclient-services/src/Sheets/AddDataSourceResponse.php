...
class AddDataSourceResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(AddDataSourceResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_AddDataSourceResponse');
