...
class GridData extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(GridData::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_GridData');
