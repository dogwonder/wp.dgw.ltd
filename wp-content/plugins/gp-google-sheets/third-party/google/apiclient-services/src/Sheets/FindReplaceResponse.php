...
class FindReplaceResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(FindReplaceResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_FindReplaceResponse');
