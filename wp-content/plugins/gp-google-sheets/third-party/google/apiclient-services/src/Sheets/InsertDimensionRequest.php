...
class InsertDimensionRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(InsertDimensionRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_InsertDimensionRequest');
