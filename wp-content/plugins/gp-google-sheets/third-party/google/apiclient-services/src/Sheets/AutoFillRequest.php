...
class AutoFillRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(AutoFillRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_AutoFillRequest');
