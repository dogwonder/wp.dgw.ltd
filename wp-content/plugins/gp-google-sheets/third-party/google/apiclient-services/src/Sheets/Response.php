...
class Response extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(Response::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_Response');
