...
class BatchUpdateValuesRequest extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BatchUpdateValuesRequest');
