...
class GradientRule extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(GradientRule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_GradientRule');
