...
class PieChartSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(PieChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PieChartSpec');
