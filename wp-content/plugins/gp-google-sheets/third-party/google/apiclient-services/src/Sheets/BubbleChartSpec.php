...
class BubbleChartSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(BubbleChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BubbleChartSpec');
