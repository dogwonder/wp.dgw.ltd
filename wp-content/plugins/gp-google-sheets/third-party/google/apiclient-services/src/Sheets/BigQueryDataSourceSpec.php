...
class BigQueryDataSourceSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BigQueryDataSourceSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BigQueryDataSourceSpec');
