...
class BasicChartSeries extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BasicChartSeries::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BasicChartSeries');
