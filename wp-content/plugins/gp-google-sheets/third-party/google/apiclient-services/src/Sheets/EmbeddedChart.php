...
class EmbeddedChart extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(EmbeddedChart::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_EmbeddedChart');
