...
class FindReplaceRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FindReplaceRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_FindReplaceRequest');
