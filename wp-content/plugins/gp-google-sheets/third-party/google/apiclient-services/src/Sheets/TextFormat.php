...
class TextFormat extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TextFormat::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_TextFormat');
