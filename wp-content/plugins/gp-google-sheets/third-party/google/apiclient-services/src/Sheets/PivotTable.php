...
class PivotTable extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(PivotTable::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotTable');
