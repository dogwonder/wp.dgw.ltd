...
class PivotGroup extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(PivotGroup::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotGroup');
