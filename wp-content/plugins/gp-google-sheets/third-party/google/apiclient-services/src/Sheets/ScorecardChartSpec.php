...
class ScorecardChartSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ScorecardChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ScorecardChartSpec');
