...
class CellData extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(CellData::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_CellData');
