...
class TreemapChartColorScale extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(TreemapChartColorScale::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_TreemapChartColorScale');
