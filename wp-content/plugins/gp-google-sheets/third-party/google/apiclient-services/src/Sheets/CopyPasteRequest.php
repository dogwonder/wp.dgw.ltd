...
class CopyPasteRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(CopyPasteRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_CopyPasteRequest');
