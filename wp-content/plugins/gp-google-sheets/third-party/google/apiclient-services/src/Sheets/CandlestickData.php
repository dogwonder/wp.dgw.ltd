...
class CandlestickData extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(CandlestickData::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_CandlestickData');
