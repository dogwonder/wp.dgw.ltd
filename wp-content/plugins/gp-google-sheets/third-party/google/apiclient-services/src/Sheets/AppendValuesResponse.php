...
class AppendValuesResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AppendValuesResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_AppendValuesResponse');
