...
class UpdateBordersRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(UpdateBordersRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_UpdateBordersRequest');
