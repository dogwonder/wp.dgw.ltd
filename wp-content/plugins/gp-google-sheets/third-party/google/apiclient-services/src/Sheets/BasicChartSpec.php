...
class BasicChartSpec extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BasicChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BasicChartSpec');
