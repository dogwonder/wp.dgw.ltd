...
class Spreadsheet extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(Spreadsheet::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_Spreadsheet');
