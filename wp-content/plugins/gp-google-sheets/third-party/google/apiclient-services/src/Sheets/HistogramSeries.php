...
class HistogramSeries extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(HistogramSeries::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_HistogramSeries');
