...
class DataSourceFormula extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DataSourceFormula::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceFormula');
