...
class AutoResizeDimensionsRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_AutoResizeDimensionsRequest');
