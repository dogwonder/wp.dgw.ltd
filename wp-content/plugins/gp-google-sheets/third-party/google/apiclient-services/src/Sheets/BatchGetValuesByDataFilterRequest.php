...
class BatchGetValuesByDataFilterRequest extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BatchGetValuesByDataFilterRequest');
