...
class OrgChartSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(OrgChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_OrgChartSpec');
