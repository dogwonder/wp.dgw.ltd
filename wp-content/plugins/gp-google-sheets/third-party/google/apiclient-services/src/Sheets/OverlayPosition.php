...
class OverlayPosition extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(OverlayPosition::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_OverlayPosition');
