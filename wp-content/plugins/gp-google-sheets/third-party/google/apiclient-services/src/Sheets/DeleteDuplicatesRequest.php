...
class DeleteDuplicatesRequest extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DeleteDuplicatesRequest');
