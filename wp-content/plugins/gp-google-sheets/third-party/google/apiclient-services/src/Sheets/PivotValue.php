...
class PivotValue extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PivotValue::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotValue');
