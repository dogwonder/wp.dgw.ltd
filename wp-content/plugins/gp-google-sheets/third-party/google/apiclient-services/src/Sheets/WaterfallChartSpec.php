...
class WaterfallChartSpec extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(WaterfallChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_WaterfallChartSpec');
