...
class DeveloperMetadata extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DeveloperMetadata::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DeveloperMetadata');
