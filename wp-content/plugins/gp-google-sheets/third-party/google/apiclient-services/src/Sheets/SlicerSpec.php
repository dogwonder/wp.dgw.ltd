...
class SlicerSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SlicerSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_SlicerSpec');
