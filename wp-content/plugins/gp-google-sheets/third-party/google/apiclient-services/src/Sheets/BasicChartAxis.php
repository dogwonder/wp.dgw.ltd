...
class BasicChartAxis extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(BasicChartAxis::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BasicChartAxis');
