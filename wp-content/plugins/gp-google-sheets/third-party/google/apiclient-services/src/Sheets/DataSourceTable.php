...
class DataSourceTable extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DataSourceTable::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceTable');
