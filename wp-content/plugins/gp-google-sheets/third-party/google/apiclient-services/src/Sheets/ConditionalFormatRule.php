...
class ConditionalFormatRule extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(ConditionalFormatRule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ConditionalFormatRule');
