...
class BandedRange extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(BandedRange::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BandedRange');
