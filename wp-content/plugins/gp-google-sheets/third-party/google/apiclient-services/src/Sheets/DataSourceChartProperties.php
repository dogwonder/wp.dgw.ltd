...
class DataSourceChartProperties extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DataSourceChartProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceChartProperties');
