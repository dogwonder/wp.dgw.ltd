...
class BasicFilter extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BasicFilter::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BasicFilter');
