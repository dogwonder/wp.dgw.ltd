...
class UpdateConditionalFormatRuleResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UpdateConditionalFormatRuleResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_UpdateConditionalFormatRuleResponse');
