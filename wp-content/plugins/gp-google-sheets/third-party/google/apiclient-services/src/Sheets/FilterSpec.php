...
class FilterSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(FilterSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_FilterSpec');
