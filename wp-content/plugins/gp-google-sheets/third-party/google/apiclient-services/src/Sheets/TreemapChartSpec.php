...
class TreemapChartSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(TreemapChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_TreemapChartSpec');
