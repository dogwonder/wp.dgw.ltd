...
class CellFormat extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(CellFormat::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_CellFormat');
