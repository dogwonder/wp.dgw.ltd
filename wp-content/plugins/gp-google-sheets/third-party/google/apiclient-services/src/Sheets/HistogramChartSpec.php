...
class HistogramChartSpec extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(HistogramChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_HistogramChartSpec');
