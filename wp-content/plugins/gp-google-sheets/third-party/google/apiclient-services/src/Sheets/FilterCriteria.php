...
class FilterCriteria extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(FilterCriteria::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_FilterCriteria');
