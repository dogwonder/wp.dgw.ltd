...
class MatchedValueRange extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(MatchedValueRange::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_MatchedValueRange');
