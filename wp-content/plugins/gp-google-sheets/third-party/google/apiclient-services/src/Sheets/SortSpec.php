...
class SortSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(SortSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_SortSpec');
