...
class BatchUpdateValuesResponse extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BatchUpdateValuesResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BatchUpdateValuesResponse');
