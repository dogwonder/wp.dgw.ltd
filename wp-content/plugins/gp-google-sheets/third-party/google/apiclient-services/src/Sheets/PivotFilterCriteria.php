...
class PivotFilterCriteria extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(PivotFilterCriteria::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotFilterCriteria');
