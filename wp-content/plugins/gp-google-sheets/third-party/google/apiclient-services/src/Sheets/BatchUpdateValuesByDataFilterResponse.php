 ...
 * the License.
 */
namespace GP_Google_Sheets\Dependencies\Google\Service\Sheets;

class BatchUpdateValuesByDataFilterResponse extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');
