...
class BandingProperties extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(BandingProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BandingProperties');
