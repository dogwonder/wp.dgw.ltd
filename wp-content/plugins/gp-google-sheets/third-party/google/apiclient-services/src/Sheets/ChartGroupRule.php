...
class ChartGroupRule extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(ChartGroupRule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ChartGroupRule');
