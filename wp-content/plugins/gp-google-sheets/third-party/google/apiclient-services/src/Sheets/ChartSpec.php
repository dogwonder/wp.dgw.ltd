...
class ChartSpec extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(ChartSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ChartSpec');
