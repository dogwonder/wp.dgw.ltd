...
class MatchedDeveloperMetadata extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_MatchedDeveloperMetadata');
