...
class PivotFilterSpec extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(PivotFilterSpec::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotFilterSpec');
