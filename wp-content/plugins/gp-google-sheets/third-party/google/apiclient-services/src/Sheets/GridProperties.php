...
class GridProperties extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GridProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_GridProperties');
