...
class UpdateValuesResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateValuesResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_UpdateValuesResponse');
