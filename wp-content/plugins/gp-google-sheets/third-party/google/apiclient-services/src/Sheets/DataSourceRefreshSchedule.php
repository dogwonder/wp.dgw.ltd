...
class DataSourceRefreshSchedule extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DataSourceRefreshSchedule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceRefreshSchedule');
