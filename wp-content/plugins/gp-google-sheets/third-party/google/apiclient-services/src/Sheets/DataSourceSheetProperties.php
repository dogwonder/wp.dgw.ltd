...
class DataSourceSheetProperties extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceSheetProperties');
