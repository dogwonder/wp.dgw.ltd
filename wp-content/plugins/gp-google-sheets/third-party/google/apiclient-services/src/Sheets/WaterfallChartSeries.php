...
class WaterfallChartSeries extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(WaterfallChartSeries::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_WaterfallChartSeries');
