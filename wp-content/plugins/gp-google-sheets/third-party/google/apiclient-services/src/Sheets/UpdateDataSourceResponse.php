...
class UpdateDataSourceResponse extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(UpdateDataSourceResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_UpdateDataSourceResponse');
