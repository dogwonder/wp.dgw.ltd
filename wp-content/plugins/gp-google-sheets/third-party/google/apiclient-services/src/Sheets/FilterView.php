...
class FilterView extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(FilterView::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_FilterView');
