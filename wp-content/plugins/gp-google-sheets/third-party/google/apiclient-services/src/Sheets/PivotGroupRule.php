...
class PivotGroupRule extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(PivotGroupRule::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_PivotGroupRule');
