...
class DataLabel extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DataLabel::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataLabel');
