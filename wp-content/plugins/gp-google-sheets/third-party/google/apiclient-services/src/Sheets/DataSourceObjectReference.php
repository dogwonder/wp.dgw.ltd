...
class DataSourceObjectReference extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DataSourceObjectReference::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataSourceObjectReference');
