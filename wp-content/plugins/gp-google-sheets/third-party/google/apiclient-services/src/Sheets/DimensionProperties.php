...
class DimensionProperties extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DimensionProperties::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DimensionProperties');
