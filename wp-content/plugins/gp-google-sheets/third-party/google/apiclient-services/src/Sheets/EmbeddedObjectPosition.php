...
class EmbeddedObjectPosition extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(EmbeddedObjectPosition::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_EmbeddedObjectPosition');
