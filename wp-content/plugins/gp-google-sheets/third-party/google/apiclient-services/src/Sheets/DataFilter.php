...
class DataFilter extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DataFilter::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DataFilter');
