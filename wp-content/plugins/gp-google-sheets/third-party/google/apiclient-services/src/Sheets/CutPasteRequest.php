...
class CutPasteRequest extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(CutPasteRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_CutPasteRequest');
