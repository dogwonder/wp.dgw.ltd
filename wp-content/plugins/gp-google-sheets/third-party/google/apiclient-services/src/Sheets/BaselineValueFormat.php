...
class BaselineValueFormat extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BaselineValueFormat::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_BaselineValueFormat');
