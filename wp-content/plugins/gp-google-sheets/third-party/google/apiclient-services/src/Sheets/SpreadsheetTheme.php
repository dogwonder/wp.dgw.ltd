...
class SpreadsheetTheme extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(SpreadsheetTheme::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_SpreadsheetTheme');
