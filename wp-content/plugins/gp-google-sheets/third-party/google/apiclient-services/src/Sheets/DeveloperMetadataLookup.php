...
class DeveloperMetadataLookup extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeveloperMetadataLookup::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DeveloperMetadataLookup');
