...
class DeveloperMetadataLocation extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(DeveloperMetadataLocation::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_DeveloperMetadataLocation');
