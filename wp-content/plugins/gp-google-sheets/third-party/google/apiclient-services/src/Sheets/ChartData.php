...
class ChartData extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ChartData::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Sheets_ChartData');
