...
class DriveFileLinkShareMetadata extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileLinkShareMetadata::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveFileLinkShareMetadata');
