...
class Permission extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(Permission::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_Permission');
