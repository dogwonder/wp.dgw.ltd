...
class DriveFile extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(DriveFile::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveFile');
