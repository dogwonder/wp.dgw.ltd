...
class Comment extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(Comment::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_Comment');
