...
class LabelModification extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(LabelModification::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_LabelModification');
