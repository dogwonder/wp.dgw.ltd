...
class AboutStorageQuota extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AboutStorageQuota::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_AboutStorageQuota');
