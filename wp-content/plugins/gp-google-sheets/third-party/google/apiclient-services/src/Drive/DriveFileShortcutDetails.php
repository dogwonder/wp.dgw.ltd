...
class DriveFileShortcutDetails extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileShortcutDetails::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveFileShortcutDetails');
