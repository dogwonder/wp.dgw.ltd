...
class DriveFileCapabilities extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileCapabilities::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveFileCapabilities');
