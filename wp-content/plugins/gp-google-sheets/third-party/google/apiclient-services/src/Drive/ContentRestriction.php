...
class ContentRestriction extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ContentRestriction::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_ContentRestriction');
