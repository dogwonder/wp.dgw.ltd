...
class TeamDrive extends \GP_Google_Sheets\Dependencies\Google\Model
{
...
\class_alias(TeamDrive::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_TeamDrive');
