...
class ModifyLabelsRequest extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(ModifyLabelsRequest::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_ModifyLabelsRequest');
