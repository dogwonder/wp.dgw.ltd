...
class DriveFileImageMediaMetadata extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(DriveFileImageMediaMetadata::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveFileImageMediaMetadata');
