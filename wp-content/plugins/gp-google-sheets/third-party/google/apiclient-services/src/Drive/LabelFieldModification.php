...
class LabelFieldModification extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(LabelFieldModification::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_LabelFieldModification');
