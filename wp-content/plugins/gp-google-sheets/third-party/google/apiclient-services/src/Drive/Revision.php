...
class Revision extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var string[]
     */
...
\class_alias(Revision::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_Revision');
