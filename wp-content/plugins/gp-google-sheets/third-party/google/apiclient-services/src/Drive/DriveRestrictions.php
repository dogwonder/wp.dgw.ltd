...
class DriveRestrictions extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveRestrictions::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveRestrictions');
