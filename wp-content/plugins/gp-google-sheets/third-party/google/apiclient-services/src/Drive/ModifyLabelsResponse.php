...
class ModifyLabelsResponse extends \GP_Google_Sheets\Dependencies\Google\Collection
{
...
\class_alias(ModifyLabelsResponse::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_ModifyLabelsResponse');
