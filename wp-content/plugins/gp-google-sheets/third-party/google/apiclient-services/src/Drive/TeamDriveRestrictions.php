...
class TeamDriveRestrictions extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveRestrictions::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_TeamDriveRestrictions');
