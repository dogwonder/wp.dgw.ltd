...
class DriveCapabilities extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveCapabilities::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_DriveCapabilities');
