...
class TeamDriveCapabilities extends \GP_Google_Sheets\Dependencies\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveCapabilities::class, 'GP_Google_Sheets\\Dependencies\\Google_Service_Drive_TeamDriveCapabilities');
