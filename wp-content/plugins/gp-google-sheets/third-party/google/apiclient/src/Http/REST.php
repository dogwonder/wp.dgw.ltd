 ...
 */
namespace GP_Google_Sheets\Dependencies\Google\Http;

use GP_Google_Sheets\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use GP_Google_Sheets\Dependencies\Google\Service\Exception as GoogleServiceException;
use GP_Google_Sheets\Dependencies\Google\Task\Runner;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('GP_Google_Sheets\\Dependencies\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \GP_Google_Sheets\Dependencies\GuzzleHttp\Message\ResponseInterface) {
