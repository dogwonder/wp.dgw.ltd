 ...
 */
namespace GP_Google_Sheets\Dependencies\Google;

use BadMethodCallException;
use DomainException;
use GP_Google_Sheets\Dependencies\Google\AccessToken\Revoke;
use GP_Google_Sheets\Dependencies\Google\AccessToken\Verify;
use GP_Google_Sheets\Dependencies\Google\Auth\ApplicationDefaultCredentials;
use GP_Google_Sheets\Dependencies\Google\Auth\Cache\MemoryCacheItemPool;
use GP_Google_Sheets\Dependencies\Google\Auth\Credentials\ServiceAccountCredentials;
use GP_Google_Sheets\Dependencies\Google\Auth\Credentials\UserRefreshCredentials;
use GP_Google_Sheets\Dependencies\Google\Auth\CredentialsLoader;
use GP_Google_Sheets\Dependencies\Google\Auth\FetchAuthTokenCache;
use GP_Google_Sheets\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use GP_Google_Sheets\Dependencies\Google\Auth\OAuth2;
use GP_Google_Sheets\Dependencies\Google\AuthHandler\AuthHandlerFactory;
use GP_Google_Sheets\Dependencies\Google\Http\REST;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Client as GuzzleClient;
use GP_Google_Sheets\Dependencies\GuzzleHttp\ClientInterface;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use GP_Google_Sheets\Dependencies\Monolog\Handler\StreamHandler as MonologStreamHandler;
use GP_Google_Sheets\Dependencies\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\GP_Google_Sheets\\Dependencies\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GP_Google_Sheets\\Dependencies\\GuzzleHttp\\ClientInterface::VERSION')) {
