...
use GP_Google_Sheets\Dependencies\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Promise\Promise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('GP_Google_Sheets\\Dependencies\\GuzzleHttp\\Promise\\Promise')) {
