 ...
 */
namespace GP_Google_Sheets\Dependencies\Google\Auth;

use DateTime;
use Exception;
use GP_Google_Sheets\Dependencies\Firebase\JWT\ExpiredException;
use GP_Google_Sheets\Dependencies\Firebase\JWT\JWT;
...
use GP_Google_Sheets\Dependencies\Google\Auth\HttpHandler\HttpClientCache;
use GP_Google_Sheets\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Psr7\Request;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Psr7\Utils;
use InvalidArgumentException;
use GP_Google_Sheets\Dependencies\phpseclib\Crypt\RSA;
use GP_Google_Sheets\Dependencies\phpseclib\Math\BigInteger as BigInteger2;
use GP_Google_Sheets\Dependencies\phpseclib3\Crypt\PublicKeyLoader;
use GP_Google_Sheets\Dependencies\phpseclib3\Math\BigInteger as BigInteger3;
use GP_Google_Sheets\Dependencies\Psr\Cache\CacheItemPoolInterface;
use RuntimeException;
use GP_Google_Sheets\Dependencies\SimpleJWT\InvalidTokenException;
use GP_Google_Sheets\Dependencies\SimpleJWT\JWT as SimpleJWT;
use GP_Google_Sheets\Dependencies\SimpleJWT\Keys\KeyFactory;
use GP_Google_Sheets\Dependencies\SimpleJWT\Keys\KeySet;
...
class AccessToken
{
    ...
    private function checkAndInitializePhpsec2() : bool
    {
        ...
        if (\filter_var(\getenv('GAE_VM'), \FILTER_VALIDATE_BOOLEAN)) {
            ...
            if (!\defined('GP_Google_Sheets\\Dependencies\\CRYPT_RSA_MODE')) {
                \define('GP_Google_Sheets\\Dependencies\\CRYPT_RSA_MODE', RSA::MODE_OPENSSL);
            }
        }
        return \true;
    }
    ...
    {
        return \class_exists('GP_Google_Sheets\\Dependencies\\phpseclib3\\Crypt\\RSA');
    }
    /**
     * @return void
     */
