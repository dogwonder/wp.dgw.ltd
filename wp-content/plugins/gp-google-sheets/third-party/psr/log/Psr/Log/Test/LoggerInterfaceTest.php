...
namespace GP_Google_Sheets\Dependencies\Psr\Log\Test;

use GP_Google_Sheets\Dependencies\Psr\Log\LoggerInterface;
use GP_Google_Sheets\Dependencies\Psr\Log\LogLevel;
use GP_Google_Sheets\Dependencies\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('GP_Google_Sheets\\Dependencies\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('GP_Google_Sheets\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('GP_Google_Sheets\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
