...
use GP_Google_Sheets\Dependencies\Monolog\Formatter\LineFormatter;
...
use GP_Google_Sheets\Dependencies\PhpConsole\Connector;
use GP_Google_Sheets\Dependencies\PhpConsole\Handler as VendorPhpConsoleHandler;
use GP_Google_Sheets\Dependencies\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('GP_Google_Sheets\\Dependencies\\PhpConsole\\Connector')) {
