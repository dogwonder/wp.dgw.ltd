...
use GP_Google_Sheets\Dependencies\GuzzleHttp\Cookie\CookieJar;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \GP_Google_Sheets\Dependencies\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
