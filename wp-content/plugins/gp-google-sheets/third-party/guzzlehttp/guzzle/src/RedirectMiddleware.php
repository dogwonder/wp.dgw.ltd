...
use GP_Google_Sheets\Dependencies\GuzzleHttp\Exception\BadResponseException;
use GP_Google_Sheets\Dependencies\GuzzleHttp\Exception\TooManyRedirectsException;
