...
namespace GP_Google_Sheets\Dependencies\GuzzleHttp\Exception;

use GP_Google_Sheets\Dependencies\GuzzleHttp\BodySummarizer;
use GP_Google_Sheets\Dependencies\GuzzleHttp\BodySummarizerInterface;
use GP_Google_Sheets\Dependencies\Psr\Http\Client\RequestExceptionInterface;
